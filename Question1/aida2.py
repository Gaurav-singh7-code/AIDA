...
goal_state = [1, 2, 3, 4, 5, 6, 7, 8, 0] #--solution exsists

#goal_state = [1, 2, 3, 5, 7, 6, 0, 8, 4] --solution does not exsists
...
initial_state = [1, 2, 3, 4, 0, 5, 6, 7, 8] #--solution exsists

#initial_state = [1, 2, 3, 5, 0, 6, 7, 8, 4]  --solution does not exsists
